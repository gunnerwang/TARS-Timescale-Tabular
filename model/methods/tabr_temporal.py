...
from model.methods.tabr import make_random_batches


class TabR_TemporalMethod(Method_Temporal):
    ...
    def construct_model(self, model_config = None):
        from model.models.tabr_temporal import TabR_Temporal
        if model_config is None:
            model_config = self.args.config['model']
        self.model = TabR_Temporal(
